...
public class BatchedVoucherModelConverterTest {
  ...
  public void testShouldConvertJSONModelToXMLModel() throws IOException {
    ...
    BatchedVoucher batchedVoucher = json.getBatchedVouchers()
      .get(0);
    ...
    assertEquals(batchedVoucher.getStatus()
      .toString(), batchedVoucherType.getStatus());
    assertEquals(batchedVoucher.getBatchedVoucherLines()
      .size(),
        batchedVoucherType.getBatchedVoucherLines()
          .getBatchedVoucherLine()
          .size());
  }
}
