...
public class InvoiceLinesApiTest extends ApiTestBase {
  ...
  public void getInvoicingInvoiceLinesTest() {
    verifySuccessGet(INVOICE_LINES_PATH, InvoiceLineCollection.class);
  }
  ...
  public void getInvoicingInvoiceLinesByIdTest() {
    ...
    final InvoiceLine resp = verifySuccessGetById(INVOICE_LINE_WITH_OPEN_EXISTED_INVOICE_ID, false, false);
