...
public class AcquisitionsUnitAssignmentsHelper extends AbstractHelper {
  ...
  CompletableFuture<Void> updateAcquisitionsUnitAssignment(AcquisitionsUnitAssignment unitAssignment) {
    String endpoint = resourceByIdPath(ACQUISITIONS_UNIT_ASSIGNMENTS, unitAssignment.getId(), lang);
  ...
  CompletableFuture<AcquisitionsUnitAssignment> getAcquisitionsUnitAssignment(String id) {
    return handleGetRequest(resourceByIdPath(ACQUISITIONS_UNIT_ASSIGNMENTS, id, lang), httpClient, ctx, okapiHeaders, logger)
  ...
  CompletableFuture<Void> deleteAcquisitionsUnitAssignment(String id) {
    return handleDeleteRequest(resourceByIdPath(ACQUISITIONS_UNIT_ASSIGNMENTS, id, lang), httpClient, ctx, okapiHeaders, logger);
  }
}
