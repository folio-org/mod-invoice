...
public enum ErrorCodes {
  ...
  USER_HAS_NO_ACQ_FISCAL_YEAR_UPDATE_PERMISSIONS("userHasNoAcqUnitsFiscalYearUpdatePermission", "User does not have permissions to update fiscal year - operation is restricted"),
