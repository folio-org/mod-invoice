...
public enum ErrorCodes {
  ...
  PO_LINE_NOT_FOUND("poLineNotFound", "The purchase order line record is not found: %s"),
  CANNOT_DELETE_INVOICE_LINE("cannotDeleteInvoiceLine", "Cannot delete invoice-line because invoice record associated with invoice-line not found: %s"),
  ...
  PO_LINE_UPDATE_FAILURE("poLineUpdateFailure", "One or more purchase order line record(s) cannot be updated: %s"),
  ...
  VOUCHER_UPDATE_FAILURE("voucherUpdateFailure", "Voucher record cannot be updated: %s"),
  ...
  ORDER_INVOICE_RELATION_CREATE_FAILED("orderInvoiceRelationCreateFailed", "Create of order invoice relation has been failed: %s"),
  INVOICE_LINE_NOT_FOUND("invoiceLineNotFound", "Invoice line not found: %s"),
  ...
  FAILED_TO_UPDATE_INVOICE_AND_OTHER_LINES("failedToUpdateInvoiceAndOtherLines", "Failed to update the invoice and other lines: %s"),
  FAILED_TO_UPDATE_PONUMBERS("failedToUpdatePoNumbers", "Failed to update invoice poNumbers: %s"),
  ...
  CANCEL_TRANSACTIONS_ERROR("cancelTransactionsError", "Failed to cancel transactions: %s"),
  ERROR_UNRELEASING_ENCUMBRANCES("errorUnreleasingEncumbrances", "Error unreleasing encumbrances after cancelling the invoice: %s"),
