...
public enum ErrorCodes {
  ...
  USER_HAS_NO_PAID_PERMISSIONS("userHasNoPaidUnitsPermission", "User does not have permissions to pay this invoice- operation is restricted"),
  USER_HAS_NO_APPROVE_PERMISSIONS("userHasNoAcqUnitsPermission", "User does not have permissions to approve this invoice - operation is restricted"),
