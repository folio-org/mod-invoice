...
public enum ErrorCodes {
  ...
  PENDING_PAYMENT_CREATION_ERROR("pendingPaymentCreationError", "Failed to create pending payments"),
  PENDING_PAYMENT_UPDATE_ERROR("pendingPaymentUpdateError", "Failed to update pending payments"),
