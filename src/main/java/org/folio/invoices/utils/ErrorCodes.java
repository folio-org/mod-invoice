...
public enum ErrorCodes {
  ...
  FUND_DISTRIBUTIONS_NOT_PRESENT("FundDistributionsNotPresent", "Fund distributions are not present in request"),
  FUND_DISTRIBUTIONS_PERCENTAGE_SUMMARY_MISMATCH("FundDistributionsPercentageSummaryMismatch", "Fund distributions percentage summary should be 100"),
