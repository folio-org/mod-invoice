...
public enum ErrorCodes {
  ...
  FUND_DISTRIBUTIONS_SUMMARY_MISMATCH("fundDistributionsSummaryMismatch", "Fund distributions summary should be 100 % or equal to subtotal for every associated invoice lines"),
